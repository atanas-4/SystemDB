    ...
    public class SystemDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Inventory>().HasData(
                new Inventory { InventoryId = 1, InventoryName = "Газов Двигател", Price = 1000, Quantity = 1 },
                new Inventory { InventoryId = 2, InventoryName = "Каросерия", Price = 400, Quantity = 1},
                new Inventory { InventoryId = 3, InventoryName = "Гуми", Quantity = 4, Price = 100 },
                new Inventory { InventoryId = 4, InventoryName = "Седалки", Price = 50, Quantity = 5 },
                new Inventory { InventoryId = 5, InventoryName = "Електрически двигател", Price = 8000, Quantity = 2 },
                new Inventory { InventoryId = 6, InventoryName = "Ватерия", Price = 400, Quantity = 5 }
            );
